...
# 🚨 ИСПРАВЛЯЕМ TOAST CONTAINER PROPS
echo "🚨 ИСПРАВЛЯЕМ TOAST CONTAINER PROPS"
echo "==================================="

# Переходим в правильную папку
cd /opt/sofiya

# 1. ПРОВЕРЯЕМ ТЕКУЩИЙ TOAST CONTAINER
echo "1️⃣ Проверяем текущий ToastContainer..."
cat frontend/components/ToastContainer.tsx

# 2. ИСПРАВЛЯЕМ SETTINGS PANEL - УБИРАЕМ TOAST CONTAINER
echo "2️⃣ Исправляем SettingsPanel - убираем ToastContainer..."
...
echo ""
echo "🎯 TOAST CONTAINER PROPS ИСПРАВЛЕНЫ!"
echo "✅ Убрали ToastContainer из SettingsPanel"
