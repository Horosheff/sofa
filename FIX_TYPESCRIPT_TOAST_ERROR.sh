...
# 🚨 ИСПРАВЛЯЕМ TYPESCRIPT TOAST ERROR
echo "🚨 ИСПРАВЛЯЕМ TYPESCRIPT TOAST ERROR"
echo "===================================="

# Переходим в правильную папку
cd /opt/sofiya

# 1. ПРОВЕРЯЕМ useToast ХУК
echo "1️⃣ Проверяем useToast хук..."
cat frontend/hooks/useToast.ts

# 2. ИСПРАВЛЯЕМ SETTINGS PANEL - УБИРАЕМ showToast
echo "2️⃣ Исправляем SettingsPanel - убираем showToast..."
...
echo ""
echo "🎯 TYPESCRIPT TOAST ERROR ИСПРАВЛЕН!"
echo "✅ showToast заменен на addToast"
